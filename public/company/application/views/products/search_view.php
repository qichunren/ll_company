...
<div id="sidebar" class="span4">
    ...
    <div id="product_search" style="margin-bottom:10px;">
      <h3>产品搜索</h3>
      <form id="search_form" method="get"><input id="keywords" type="text" value="<?php echo urldecode($this->uri->segment(3)); ?>" name="keywords" /><button type="submit" class="btn">搜</button></form>
    </div>
